...
class ParticipantData private constructor(content: ByteArray){
    ...
    companion object{
        ...
        fun getAiControlled(aiControlled: UByte) = Resources.getSystem().getString(when(aiControlled.toInt()){
            0 -> R.string.ai_human
            1 -> R.string.ai_npc
            else -> R.string.unknown
        })

        fun getNationality(nationality: UByte) = Resources.getSystem().getString(when(nationality.toInt()){
        ...
        fun getTeam(teamId: UByte) = Resources.getSystem().getString(when(teamId.toInt()){
        ...
        fun getDriver(driverId: UByte) = Resources.getSystem().getString(when(driverId.toInt()){
